...
with app.test_client() as client:
    ...
    checks = [
        ...
        ('Dropdown positioning fix', "dropdown.style.position = 'fixed'" in content),
    ...
    with app.test_client() as client:
        ...
        for name, check in [
            ...
            ('Toggle Description', 'toggleDescription'),
            ('Address toggle', 'address-cell'),
            ('Address full hidden', 'address-full hidden'),
            ('Description cell class', 'address-cell'),
        ]:
